...
<body>
    <div id="wrap">
            ...
            <div class="main-menu-area">
                <div class="main-menu">
                    ...
                    <div class="sub-menu-area">
                        ...
                        <div class="sub-menu">대전 소개</div>
                        <div class="sub-menu">로그인 및 회원가입</div>
                        <div class="sub-menu">행사개요</div>
                    </div>
                </div>
        ...
        <footer>
            ...
            <div id="copyright">(54819) 전주시 덕진구 솔내로 212 (송천동2가 168-5) | 전화 : 063-281-6535 | 팩스 : 063-281-5286<br>
                <span>COPYRIGHT 2020 전주독서대전. ALL RIGHT RESERVED.</span></div>
            <div id="icon_list">
